...
CREATE TABLE device (
  ...
  device_tp_id number(10) NOT NULL, 
  device_name  varchar2(255), 
  device_state varchar2(255), 
...
ALTER TABLE technology ADD CONSTRAINT FKtechnology656379 FOREIGN KEY (tp_job_id) REFERENCES job (job_id);
