...
<body>
    ...
    <div class="content">
        ...
        <div class="action-buttons">
            <button onclick="modalAddDevice()">Добавить устройство</button>
            <button onclick="modalDeleteDevice()">Удалить устройство</button>
        </div>
        ...
        <div id="modalAddDevice" class="modal">
            <div class="modal-content">
                ...
                <form action="add.php" method="post">
                    <input type="text" id="name" name="name" placeholder="Название устройства" required>
                    <input type="submit" value="Добавить">
                </form>
            </div>
        </div>
        <!-- Модальное окно для удаления устройства-->
        <div id="modalDeleteDevice" class="modal">
            <div class="modal-content">
                <span class="close" onclick="closeModal()">&times;</span>
                <h2>Удалить устройство</h2>
                <form action="delete.php" method="post">
                    <input type="text" id="id" name="id" placeholder="Идентификатор устройства" required>
        ...
        function modalDeleteDevice() {
            document.getElementById("modalDeleteDevice").style.display = "block";
        }
        function closeModal() {
            document.getElementById("modalAddDevice").style.display = "none";
            document.getElementById("modalDeleteDevice").style.display = "none";
        }
        </script>
        ...
        try {
            ...
            $sql = "SELECT device_id, device_name FROM device ORDER BY device_id DESC";
